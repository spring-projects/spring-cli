...
A template engine, by default Handlebars, is used to model the contents of the code or configuration to be added to a new file or injected into an existing file.
