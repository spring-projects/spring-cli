...
This command creates the file https://github.com/spring-projects-experimental/spring-cli/blob/main/src/test/resources/sample-output/README-ai-jpa-simple-description.md[README-ai-jpa.md] and applies the changes described in that file to the project.
...
This command creates the file https://github.com/spring-projects-experimental/spring-cli/blob/main/src/test/resources/sample-output/README-ai-jpa-simple-description.md[README-ai-jpa.md] without modifying the project.  It allows you to review the generated content and assess its suitability for your needs.
...
Additonal context is added to the criteria through the description provided in the `ai add` command.
...
If you examine the file https://github.com/spring-projects-experimental/spring-cli/blob/main/src/test/resources/sample-output/README-ai-jpa-simple-description.md[README-ai-jpa.md] from the previous step, you will notice that it did not include any tests.
...
Here the https://github.com/spring-projects-experimental/spring-cli/blob/main/src/test/resources/sample-output/README-ai-jpa-with-test.md[README-ai-jpa.md] file that was created using the previous command.
...
Here the https://github.com/spring-projects-experimental/spring-cli/blob/main/src/test/resources/sample-output/README-ai-jpa-rewrite.md[README-ai-jpa.md] file that was created using the previous command.
