...
public class CommandManifestReaderTests {
	...
	void deserialization() throws IOException {
		CommandManifest commandManifest = CommandManifestReader.read(Paths.get("src/test/resources",
				packageAsPath(CommandManifestReaderTests.class), "manifest-full-deserialization.yaml"));

		// Test command
		Command command = commandManifest.getCommand();
